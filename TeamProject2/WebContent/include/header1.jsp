				...
				<div class="nav">
					<nav>
						<ul class="navi">
							...
							<li><a href="#">관리</a>
								<ul class="navi2">
									<li><a href="/Admin/machine/machine_list.do">기기 관리</a></li>
									<li><a href="/Admin/machine/card_list.do">카드데이터관리</a></li>
									<li><a href="/Admin/machine/card_record_list.do">카드충전이력관리</a></li>
								</ul>
							</li>
							<li><a href="/Admin/order/order_list.do">발주관리</a>
								<ul class="navi2">
									<li><a href="/Admin/order/order_hunwang.do">발주현황</a></li>
