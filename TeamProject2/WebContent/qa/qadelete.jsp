...
<c:if test="${row==1}">
	<script>
		alert("삭제되었습니다..");
		window.opener.location.replace("/qa/qa_list.do?page=${page}");
		self.close();
	</script>
</c:if>
<c:if test="${row==0}">
...
<link rel="stylesheet" type="text/css" href="/stylesheet.css">
 <script>
	function del(){
		...
		pds.action="/qa/qa_delete_pro.do";
		pds.submit();
	}
</script>
</head>
...
<form method="post" name="pds">
  ...
  <tr>
    ...
    <font size="2" face="돋움">비밀번호 <input type="password" name="pass" size="8" value=""></font>
